  ...
  return (
    <>
      <div className="glass rounded-2xl p-6 flex flex-col items-center gap-4">
        ...
        <div className="text-center space-y-1">
          <p className="text-xs text-slate-400">
            Practice started at{" "}
            <span className="text-slate-200 font-medium">{sessionDate}</span>
          </p>
          {creatorName && (
            <p className="text-xs text-emerald-400 font-medium flex items-center justify-center gap-1.5">
              <span className="w-1.5 h-1.5 rounded-full bg-emerald-400" />
              QR generated by: <span className="text-emerald-300 font-semibold">{creatorName}</span>
            </p>
          )}
        </div>
      ...
      {isFullscreen && (
        ...
        >
          <div className="text-center space-y-1">
            <p className="text-[#0a0f0d] text-2xl font-extrabold tracking-tight">
              Scan to Check In — {sessionDate}
            </p>
            {creatorName && (
              <p className="text-emerald-800 text-sm font-semibold">
                Generated by: {creatorName} (Attendance auto-logged)
              </p>
            )}
          </div>
          <canvas
